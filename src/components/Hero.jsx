  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi,I'm <span className='text-[#915eff] '>Roshan</span></h1>
          <p className={`${styles.heroSubText} mt-2 `}>I devlop 3d  visual , user<br className='sm:hidden'/> interfaces and web applications</p>
        </div>
      </div>
      <ComputersCanvas />
