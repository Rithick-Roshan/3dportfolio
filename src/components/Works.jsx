...
const ProjectCard = ({ index, name, description, tags, image, source }) => {
  return (
  ...
  return (
    <>
       <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} mx-2`}>My projects</p>
        <h2 className={`${styles.sectionHeadText} mx-2`}>Projects.</h2>
      </motion.div>
